...
# Run Pandoc
eval pandoc "-i \"${INPUT_FILE}\" --katex --standalone --highlight-style=pygments --wrap=preserve -f markdown+lists_without_preceding_blankline -t html -o \"${OUTPUT_DIRECTORY}/${OUTPUT_FILE}\"" > /dev/null 2>&1
